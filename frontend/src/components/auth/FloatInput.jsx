...
export default function FloatInput({ icon: Icon, type, label, name, onInput }) {
  ...
  return (
    <div className="relative group ">
      ...
      <input id={id} type={isPass ? (show ? "text" : "password") : type} name={name} placeholder=" " onInput={onInput}
